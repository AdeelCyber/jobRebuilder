      ...
      <>
        ...
        >
          ...
          <Stack.Screen
            name="Message"
            component={Message}
            initialParams={{ toggleBar: props.ToggleBar }}
          />
          ...
          />
          <Stack.Screen name="LinkStatus" component={PaymentLinkStatus} />
    ...
    >
      ...
      <NavigationContainer>
        ...
        {userdetails?.role === "Freelancer" ? (
          <FreelancerTabBar showBar={props.showBar} />
        ) : userdetails?.role?.includes("Startup") ? (
          <TabBar show={accessToken} />
        ) : (
          <UserTabBar show={userTab} showBar={props.showBar} />
        )}
      </NavigationContainer>
    </SafeAreaView>
  );
