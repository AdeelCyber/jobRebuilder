...
const EditService = () => {
    ...
    const deleteItem = (id) => {
          ...
          const r= skillsofuser.filter((i) => i.id != id)
        ...
        <ScrollView style={{ backgroundColor: colors.background }}>
            ...
            <View style={[styles.container, {marginTop:30}]}>
                <View style={{ flexDirection: "row", justifyContent: "space-evenly" }}>
                    ...
                    {description ? <TouchableOpacity style={styles.btnstyle}
                        onPress={() => {
                ...
                {description && (
                    <View style={{ marginTop: 30 }}>
                        <View style={styles.box}>
                            <TextInput style={{ fontSize: 11, fontWeight: "400", margin: 20, textAlign: "justify" }}
                             value={userdesc}
                ...
                {skills && (
                    <View style={{marginTop:30}}>
                     <View style={[styles.box, { height: 100, shadowColor: colors.Bluish, padding: 10}]}>
                     ...
                     <FlatList
                         ...
                         renderItem={({ item , index}) => (
                             <View style={{ marginTop: 15, marginLeft: 10, height: 22, width: 90, backgroundColor: colors.Bluish, borderRadius: 5 }}>
                                 ...
                                 <MyText style={{ color: colors.white, fontSize: 11, fontWeight: "400", alignSelf: "center", margin: 3, marginLeft:5 }}>
                                     {item.skill}
                                 </MyText>
                                 <TouchableOpacity style={{justifyContent:"flex-end", alignItems:"flex-end"}}
                                 onPress={()=>{deleteItem(item.id)
                                 console.log(item.id)}}>
                                    <MyText style={{color:colors.white, fontSize:9, margin:5}}>
                                        X
                                    </MyText>
                                 </TouchableOpacity>
                                 </View>
